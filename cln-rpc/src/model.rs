...
pub mod responses {
	...
	impl TryFrom<i32> for ListclosedchannelsClosedchannelsChannel_typeNames {
	    ...
	    fn try_from(c: i32) -> Result<ListclosedchannelsClosedchannelsChannel_typeNames, anyhow::Error> {
	        match c {
	    0 => Ok(ListclosedchannelsClosedchannelsChannel_typeNames::STATIC_REMOTEKEY),
	    1 => Ok(ListclosedchannelsClosedchannelsChannel_typeNames::ANCHOR_OUTPUTS),
	    2 => Ok(ListclosedchannelsClosedchannelsChannel_typeNames::ANCHORS_ZERO_FEE_HTLC_TX),
	    3 => Ok(ListclosedchannelsClosedchannelsChannel_typeNames::SCID_ALIAS),
	    4 => Ok(ListclosedchannelsClosedchannelsChannel_typeNames::ZEROCONF),
